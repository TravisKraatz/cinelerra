...
{
//printf("Edit::shift 1 %p " _LD " " _LD "\n", this, startproject, difference);
	startproject += difference;
//printf("Edit::shift 2 " _LD " " _LD "\n", startproject, difference);
}
...
//printf("Edit::shift_start_out 1 " _LD " " _LD "\n", startsource, cut_length);
	...
	if(edit_mode == MOVE_ALL_EDITS)
	{
//printf("Edit::shift_start_out 10 " _LD "\n", cut_length);
		startsource -= cut_length;
		length += cut_length;
