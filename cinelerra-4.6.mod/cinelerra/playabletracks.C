 ...
 : ArrayList<Track*>()
{
		...
		current_track = current_track->next)
	{
		...
		{
// printf("PlayableTracks::PlayableTracks %d this=%p current_track=%p total=%d current_position=" _LD "\n", 
// __LINE__,
// this, 
// current_track,
// total, 
...
// printf("PlayableTracks::PlayableTracks %d data_type=%d total=%d current_position=" _LD "\n", 
// __LINE__,
// data_type, 
// total, 
// current_position);
