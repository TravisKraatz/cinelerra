...
a52_bitstream_get_bh(uint32_t num_bits)
{
    ...
    result = ((a52_current_word << (32u - a52_bits_left)) >>
	      (32u - a52_bits_left));

    bitstream_fill_current();

    if(num_bits != 0)
	result = (result << num_bits) | (a52_current_word >> (32u - num_bits));

    a52_bits_left = 32u - num_bits;
...
a52_bitstream_get_bh_2(uint32_t num_bits)
{
    ...
    num_bits -= a52_bits_left;
    result = ((((int32_t)a52_current_word) << (32u - a52_bits_left)) >>
	      (32u - a52_bits_left));
